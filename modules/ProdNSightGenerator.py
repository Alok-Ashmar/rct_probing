...
class ImmediateEvaluation(BaseModel):
    """Metrics we need early to decide whether to keep streaming."""
...
class DetailedMetrics(BaseModel):
    """Detailed metrics that can finish after the first websocket payload."""
...
class NSIGHT(DetailedMetrics, ImmediateEvaluation):
    """Combined metrics payload used for persistence."""
